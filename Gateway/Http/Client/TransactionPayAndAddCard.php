...
class TransactionPayAndAddCard implements ClientInterface
{
    /**
     ...
     * @return array
     */
    public function payAndAddCard($paytrailPayment, $order): array
    {
        $response["data"] = null;
        $response["error"] = null;
        ...
        try {
            ...
            $loggedData = $this->json->serialize([
                ...
                'href' => $response["data"]->getRedirectUrl()
            ]);
