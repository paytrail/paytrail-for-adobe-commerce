...
Resolver::getInstance()
    ->requireDataFixture('Paytrail_PaymentService::Test/Integration/_files/subscription_payment_rollback.php');
Resolver::getInstance()
    ->requireDataFixture('Paytrail_PaymentService::Test/Integration/_files/subscription_payment_save.php');

$subscriptionRepository = Bootstrap::getObjectManager()
    ->create(\Paytrail\PaymentService\Api\SubscriptionRepositoryInterface::class);
...
$collection = Bootstrap::getObjectManager()
    ->create(\Paytrail\PaymentService\Model\ResourceModel\Subscription\Profile\Collection::class);
